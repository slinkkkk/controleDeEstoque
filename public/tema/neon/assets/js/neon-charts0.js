	...
	$(document).ready(function()
	{
		...
		if(typeof Rickshaw != 'undefined')
		{
			...
			var graph = new Rickshaw.Graph( {
					...
					height: 120,
					series: [ {
							data: [ { x: 0, y: 1 }, { x: 1, y: 0 }, {x: 2, y: 1}, {x: 3, y: 1}, {x: 4, y: 0} ],
							color: 'lightblue'
					}/*, {	
		...
		if(typeof Morris != 'undefined')
		{
			...
			/*
			{"elapsed": "00:00", "value": 1},
			{"elapsed": "06:00", "value": 1},
			{"elapsed": "08:35", "value": 0},
			{"elapsed": "12:00", "value": 0},
			{"elapsed": "18:00", "value": 1},
			{"elapsed": "00:00", "value": 1}
			*/
			...
			Morris.Area({
				element: 'chart10',
				data: [
					{ y: '01:00', a: getRandomInt(0,1)},
					{ y: '02:00', a: getRandomInt(0,1)},
					{ y: '03:00', a: getRandomInt(0,1)},
					{ y: '04:00', a: getRandomInt(0,1)},
					{ y: '05:00', a: getRandomInt(0,1)},
					{ y: '06:00', a: getRandomInt(0,1)},
					{ y: '07:00', a: getRandomInt(0,1)},
					{ y: '08:00', a: getRandomInt(0,1)}
